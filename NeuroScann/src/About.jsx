...
const Homepage = () => {
    ...
    return (
        <div>
            ...
            <div className="max-w-screen-md mx-auto px-4 py-8 text-white">
      <h2 className="text-5xl font-bold mb-4">Motivation</h2>
      <p className="text-lg mb-4">I was motivated by the challenges posed by brain tumors. Brain tumors are complex and come in various sizes and locations, making them difficult to understand fully. Additionally, analyzing MRI scans requires the expertise of a professional neurosurgeon. In many developing countries, the shortage of skilled doctors and lack of knowledge about tumors make it challenging and time-consuming to generate reports from MRI scans.</p>
      <p className="text-lg">An automated system hosted on the cloud can address this challenge effectively. The automated system would be capable of detecting the presence of a tumor in MRI scans and accurately identifying the type of tumor. Furthermore, it would maintain detailed patient records and track tumor size over time. By providing a list of doctors, recommendations, and further medical diagnostic procedures, the system would help alleviate confusion and provide guidance to patients.</p>
    </div>
